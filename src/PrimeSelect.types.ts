export type TCreateSelector = <Args extends unknown, R extends unknown>(mainProps: {
    /**
...
type TCreateSelectorReturnType<Args extends unknown, R extends unknown> = (options: {
    props: Args;
    /**
